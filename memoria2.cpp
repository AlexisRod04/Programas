...
int main () {
	...
	cout<<"el valor del primer elemento es:"<<*(ptrc+1endl;
	
	cout<<"la direccion del primer elemento es:"<<&ptrc+2<<endl;
	cout<<"el valor del primer elemento es:"<<*(ptrc+2)<<endl<<endl;
	
	cout<<"la direccion del primer elemento es:"<<&ptrc+3<<endl;
	cout<<"el valor del primer elemento es:"<<*(ptrc+3)<<endl<<endl;
	
	cout<<"la direccion del primer elemento es:"<<&ptrc+4<<endl;
	cout<<"el valor del primer elemento es:"<<*(ptrc+4)<<endl<<endl;
